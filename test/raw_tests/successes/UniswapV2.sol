...
// Note: Dune also has an equivalent isqrt primitive
...
// Not needed : uints are bounded on Dune
...
//        }
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                keccak256('EIP712Domain(string name,string version,bytes4 chainId,address verifyingContract)'),
...
//!!! Conversion uint(-1) forbidden because uint is unbounded int
//!!! Either use uint256, or use a pair/record with a flag
...
//inherit from interface / virtual fun and conrete fun ? multiple inheritance ?
