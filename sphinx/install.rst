...
If :code:`ocaml-solidity` is available in your opam repository, you can just call::

  opam install ocaml-solidity

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`ocaml-solidity` in a directory.
