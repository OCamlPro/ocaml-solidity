...
# -*- coding: utf-8 -*-
#
# ocaml-solidity documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ocaml-solidity.tex', 'ocaml-solidity Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ocaml-solidity', 'ocaml-solidity Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ocaml-solidity', 'ocaml-solidity Documentation',
     author, 'ocaml-solidity', 'One line description of project.',
     'Miscellaneous'),
]
