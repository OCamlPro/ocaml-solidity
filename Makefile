...
build:
	...
	./scripts/copy-bin.sh ocaml-solidity ez-hash ocaml-solidity-common ocaml-solidity-parser ocaml-solidity-checker ocaml-solidity-test ocaml-solidity-alcotest
